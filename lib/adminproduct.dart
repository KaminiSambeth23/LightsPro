...
import 'package:lights_pro/editproduct.dart';
import 'package:lights_pro/newproduct.dart';
import 'package:lights_pro/product.dart';
...
class _AdminProductState extends State<AdminProduct> {
  ...
  void _loadSingleProduct(String prid) {
    String urlLoadJobs = server + "/php/insert_product.php";
